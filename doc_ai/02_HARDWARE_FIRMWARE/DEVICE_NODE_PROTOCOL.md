...
1. Команда на включение/дозирование насоса (`SET_STATE` / `DOSE`) обрабатывается так:
...
1. Команда на включение насоса (например, `SET_STATE` или `DOSE`) обрабатывается так:
