...
12. ✅ **Завершено:** Улучшение Watchdog (Фаза 2, задача 3.3) - создан унифицированный компонент, интегрирован в node_framework, обновлены все ноды (ph_node, ec_node, climate_node, pump_node) и heartbeat_task (95%)
