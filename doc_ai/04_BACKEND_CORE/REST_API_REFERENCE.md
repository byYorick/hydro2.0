...
Инварианты `GET /zones/{id}/state`:
- response включает блок `observability` (`runtime`, `nodes`, `hang_hints`, `overall_health`);
- hint generation: `ae3lite/application/services/automation_observability.py`;
