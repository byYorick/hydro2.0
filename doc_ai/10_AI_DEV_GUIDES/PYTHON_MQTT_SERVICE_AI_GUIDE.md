...
- при получении сообщений:
 - разобрать топик по схеме `MQTT_NAMESPACE.md`;
...
- Схема БД описана в `DATA_MODEL_REFERENCE.md` и `DATABASE_SCHEMA_AI_GUIDE.md`.
...
1. Не менять базовый формат MQTT-топиков (см. `MQTT_NAMESPACE.md`).
