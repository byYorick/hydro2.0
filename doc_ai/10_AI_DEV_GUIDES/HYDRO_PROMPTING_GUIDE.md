...
- Пройдитесь по релевантным `AGENTS.md` и конвенциям в каталоге задачи, зафиксируйте версии фреймворков и зависимостей.
...
- **Документация и спецификации:** задайте целевой раздел, формат (списки, таблицы, диаграммы), язык (RU/EN) и необходимость зеркала в `docs/`.
