...
- **[DOCUMENTATION_AUDIT_AND_CLEANUP.md](DOCUMENTATION_AUDIT_AND_CLEANUP.md)** — план упорядочивания документации
...
- [Отчет о несоответствиях](INCONSISTENCIES_REPORT.md) — найденные проблемы
- [План упорядочивания](DOCUMENTATION_AUDIT_AND_CLEANUP.md) — план улучшения документации
...
- При обнаружении несоответствий см. `INCONSISTENCIES_REPORT.md` и `SYNC_PLAN.md`
