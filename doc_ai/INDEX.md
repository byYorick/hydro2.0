...
- `04_BACKEND_CORE/AE3_CONFIG_REFACTORING_PLAN.md` — план рефакторинга config-системы AE3 (Phases 0-7 shipped) + config modes locked/live + hot-reload спецификация
- `04_BACKEND_CORE/AE3_CONFIG_REFACTORING_AUDIT_PHASE_0_2.md` — аудит Phase 0-2 (12 findings)
- `04_BACKEND_CORE/AE3_CONFIG_REFACTORING_AUDIT_PHASE_5.md` — аудит Phase 5/5.1/5.5 (3 CRITICAL + 2 MAJOR fixes)
- `04_BACKEND_CORE/AE3_CONFIG_PARAMETER_INVENTORY.md` — Phase 0 inventory hardcoded параметров
