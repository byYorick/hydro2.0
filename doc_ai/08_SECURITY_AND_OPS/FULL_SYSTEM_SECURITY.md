...
| Роль | Полив | Дозирование | Рецепты | Grow-cycle | Настройки | Узлы |
|------|-------|-------------|---------|------------|-----------|------|
| admin | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
| operator | ✓ | ✓ | ограничено | ограничено | ограничено | ограничено |
| agronomist | ✓ | ✓ | ✓ | ✓ | ✗ | ограничено |
| engineer | ограничено | ограничено | ограничено | ✗ | ограничено | ✓ |
| viewer | ✗ | ✗ | ✗ | ✗ | ✗ | чтение |
