...
**Target / planned** (см. §8.4 — automated versioning + OTA publish **не** реализованы):

- На merge в main/release: сборка артефактов в CI;
- инкремент версий + загрузка в OTA storage — будущий release workflow.
