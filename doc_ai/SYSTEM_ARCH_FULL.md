...
Решения по `pH/EC`, поливу и досветке принимаются **на уровне зоны**.
Общий климат теплицы принимается **на уровне greenhouse**, при этом зональный climate
может использоваться как отдельный subsystem для `CO2` и прикорневой вентиляции.
