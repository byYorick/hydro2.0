...
2. **Greenhouses** – список теплиц
3. **Zones** – список всех зон теплицы
4. **Zone Detail** – *главный рабочий экран*
5. **Devices** – узлы ESP, каналы, диагностика
6. **Recipes & Crops** – рецепты выращивания и культуры
7. **Alerts & Events**
8. **Settings**
9. **AI Panel** (рекомендации/чат/оптимизации)
...
- Последние 5–10 аварий
- Мини-графики pH / EC / t° / RH (за сутки)
- Heatmap зон по статусам
- Кнопка → перейти к Zones
