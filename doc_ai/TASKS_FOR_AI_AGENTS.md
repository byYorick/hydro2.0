...
Задачи «прогнать / починить e2e на реальной test_node» должны ссылать агента на
`doc_ai/13_TESTING/REALHW_TEST_NODE_AGENT_GUIDE.md` и `tests/e2e/AGENTS.md`
(не Playwright, не `run_e2e.sh` с node-sim, не HIL 8080/1883).
