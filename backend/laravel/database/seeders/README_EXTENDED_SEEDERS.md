...
Создает:
- Исторические данные телеметрии за последние 7 дней (интервал 5 минут)
...
Создает:
- Агрегированную телеметрию по 1 минуте (за 7 дней)
- Агрегированную телеметрию по 1 часу (за 30 дней)
- Дневную агрегированную телеметрию (за 90 дней)
