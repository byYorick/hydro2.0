    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div class="bg-[color:var(--bg-elevated)] rounded-lg p-3">
          ...
          <div class="text-2xl font-bold text-[color:var(--text-primary)]">
            {{ zones.length }}
          </div>
        </div>
        <div class="bg-[color:var(--bg-elevated)] rounded-lg p-3">
        ...
        <div class="bg-[color:var(--bg-elevated)] rounded-lg p-3">
          ...
          <div
            ...
            :class="alertsTotal > 0 ? 'text-[color:var(--accent-red)]' : 'text-[color:var(--text-dim)]'"
          >
            {{ alertsTotal }}
          </div>
        </div>
      ...
      <div class="space-y-3">
        ...
        <div
          v-else
          class="text-sm text-[color:var(--text-muted)] py-8 text-center"
        >
