            ...
            <div v-if="open" class="cal-drawer-overlay" @click.self="$emit('close')">
                <aside class="cal-drawer" role="dialog" aria-modal="true">
                    <header class="cal-drawer__header">
                        <div>
                            <div class="cal-drawer__title">Automation blockers</div>
...
defineEmits<{
    (e: 'close'): void;
    (e: 'navigate', contract: AutomationContract): void;
}>();
</script>
...
.cal-drawer__title { font-size: 1rem; font-weight: 700; }
.cal-drawer__subtitle { font-size: 0.75rem; opacity: 0.7; margin-top: 0.1rem; }
.cal-drawer__close {
...
.cal-drawer__body { flex: 1 1 auto; overflow-y: auto; padding: 0.8rem 1rem; }
.cal-drawer__empty {
...
.cal-drawer__item-title { font-weight: 600; font-size: 0.9rem; }
.cal-drawer__item-desc { font-size: 0.78rem; opacity: 0.8; line-height: 1.35; }
...
.cal-drawer__item-btn:hover { background: rgb(14, 165, 233); }

.cal-drawer-enter-from, .cal-drawer-leave-to { opacity: 0; }
.cal-drawer-enter-active, .cal-drawer-leave-active { transition: opacity 200ms ease; }
.cal-drawer-enter-active .cal-drawer, .cal-drawer-leave-active .cal-drawer { transition: transform 220ms ease; }
.cal-drawer-enter-from .cal-drawer, .cal-drawer-leave-to .cal-drawer { transform: translateX(100%); }
</style>
