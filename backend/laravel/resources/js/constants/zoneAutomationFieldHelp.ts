export const ZONE_AUTOMATION_FIELD_HELP: Record<string, string> = {
  ...
  'water.irrigationAutoReplayAfterSetup': 'После setup из-за solution_min автоматически повторить полив (irrigation_start). Выключено — задача завершится без replay.',
