export const ZONE_AUTOMATION_FIELD_HELP: Record<string, string> = {
  ...
  'water.irrigationAutoReplayAfterSetup': 'После setup из-за solution_min автоматически повторить полив (irrigation_start). Также разрешает AE3 replay normal irrigation после setup, если initial launch был отложен или оборван safety-path. Выключено — задача завершится без replay.',
  'water.irrigationMaxSetupReplays': 'Сколько раз runtime может автоматически переиграть irrigation после setup без нового operator trigger.',
  ...
  'water.correctionDuringIrrigation': 'Включает inline-коррекцию на поливе: всегда pH + EC (Ca или NPK на выбор).',
  'water.irrigationEcComponent': 'EC на поливе при включённой коррекции: calcium (pump_b → T_ca) или npk (pump_a → T_ca_mg_npk). pH всегда вместе с EC.',
