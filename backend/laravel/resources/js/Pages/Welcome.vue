      ...
      <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
        ...
        >
          <div class="flex lg:col-start-2 lg:justify-center">
            <svg
              class="h-12 w-auto text-[color:var(--accent-green)] lg:h-16"
              viewBox="0 0 62 65"
              fill="none"
          ...
          >
            <Link
              ...
              class="rounded-md px-3 py-2 text-[color:var(--text-muted)] ring-1 ring-transparent transition hover:text-[color:var(--text-primary)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--focus-ring)]"
            >
              Dashboard
            </Link>
        ...
        <main class="mt-6">
          <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
              ...
              >
                ...
                >
                  ...
                  <div class="pt-3 sm:pt-5 lg:pt-0">
                    <h2
                      class="text-xl font-semibold text-[color:var(--text-primary)]"
                    >
                      Documentation
                    </h2>
                ...
                <svg
                  class="size-6 shrink-0 stroke-[color:var(--accent-green)]"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke-width="1.5"
            ...
            >
              ...
              <svg
                class="size-6 shrink-0 self-center stroke-[color:var(--accent-green)]"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                stroke-width="1.5"
        ...
        <footer
          class="py-16 text-center text-sm text-[color:var(--text-muted)]"
        >
