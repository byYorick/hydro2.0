            ...
            <tbody>
              <tr v-if="isLoading">
                <td colspan="5" class="px-3 py-6">
                  <SkeletonBlock :lines="5" line-height="0.75rem" />
                </td>
              </tr>
              <template v-else>
                <tr
                ...
                <tr v-if="!paginatedAlerts.length">
                  <td colspan="5" class="px-3 py-6">
                    <EmptyState
                      ...
                      description="Попробуйте изменить фильтры или дождитесь новых событий."
...
const isLoading = computed(() => !Array.isArray(page.props.alerts))
