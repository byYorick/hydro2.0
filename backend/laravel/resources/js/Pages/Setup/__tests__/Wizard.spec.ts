  ...
  if (url === '/api/nodes') {
    return Promise.resolve({
      data: {
        status: 'ok',
        data: [
          { id: 101, uid: 'nd-irrig-1', type: 'irrig', channels: [{ channel: 'pump_main' }] },
      ...
      if (url === '/api/nodes') {
        return Promise.resolve({
          data: {
            status: 'ok',
            data: [
              { id: 101, uid: 'nd-irrig-bound', type: 'controller', zone_id: '20', channels: [{ binding_role: 'pump_main' }] },
              { id: 102, uid: 'nd-ph-bound', type: 'controller', zone_id: '20', channels: [{ binding_role: 'pump_acid' }] },
              { id: 104, uid: 'nd-ec-bound', type: 'controller', zone_id: '20', channels: [{ binding_role: 'pump_a' }] },
            ],
          },
        })
      }
          ...
          data: {
            ...
            data: [
              ...
              },
              {
                ...
                type: 'controller',
                zone_id: '20',
                channels: [{ binding_role: 'pump_acid' }],
              },
              {
                id: 104,
                uid: 'nd-ec-bound',
