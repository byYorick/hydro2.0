/**
 * Типы для Setup Wizard — wizard-specific DTO, упрощённые проекции сущностей.
 * Намеренно отличаются от основных типов в types/ — это domain-specific типы для шагов мастера.
 * Импортировать через: import type { ... } from '@/types/SetupWizard'
 */
