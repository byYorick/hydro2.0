...
describe('zoneAutomationFormLogic', () => {
  ...
  it('buildGrowthCycleConfigPayload нормализует значения и выключает drain для 2 баков', () => {
    ...
    expect(payload.subsystems.diagnostics.execution.correction.ec_mix_wait_sec).toBe(95)
    expect(payload.subsystems.diagnostics.execution.correction.ph_mix_wait_sec).toBe(70)
