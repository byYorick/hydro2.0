...
export function createDefaultWaterForm(defaults: AutomationDefaultsSettings): WaterFormState {
  return {
    ...
    prepareToleranceEcPct: defaults.water_prepare_tolerance_ec_pct,
    prepareTolerancePhPct: defaults.water_prepare_tolerance_ph_pct,
    ...
    twoTankIrrigationStartSteps: defaults.water_two_tank_irrigation_start_steps,
    twoTankIrrigationStopSteps: defaults.water_two_tank_irrigation_stop_steps,
    twoTankCleanFillStartSteps: defaults.water_two_tank_clean_fill_start_steps,
    twoTankCleanFillStopSteps: defaults.water_two_tank_clean_fill_stop_steps,
    twoTankSolutionFillStartSteps: defaults.water_two_tank_solution_fill_start_steps,
    twoTankSolutionFillStopSteps: defaults.water_two_tank_solution_fill_stop_steps,
    twoTankPrepareRecirculationStartSteps: defaults.water_two_tank_prepare_recirculation_start_steps,
    twoTankPrepareRecirculationStopSteps: defaults.water_two_tank_prepare_recirculation_stop_steps,
    twoTankIrrigationRecoveryStartSteps: defaults.water_two_tank_irrigation_recovery_start_steps,
    twoTankIrrigationRecoveryStopSteps: defaults.water_two_tank_irrigation_recovery_stop_steps,
