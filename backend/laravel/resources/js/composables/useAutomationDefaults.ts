...
export function createDefaultClimateForm(defaults: AutomationDefaultsSettings): ClimateFormState {
  return {
    ...
    minCommandIntervalSeconds: 300,
    dayStart: defaults.climate_day_start_hhmm,
    nightStart: defaults.climate_night_start_hhmm,
    daylightLuxThreshold: 15000,
    ventMinPercent: defaults.climate_vent_min_pct,
    ventMaxPercent: defaults.climate_vent_max_pct,
    minSafeOpenPercent: defaults.climate_vent_min_pct,
    fallbackOpenPercent: 5,
    weatherStaleMaxOpenPercent: 20,
    emergencyOpenPercent: 100,
    positionDeadbandPercent: 5,
    nightBaseOpenPercent: defaults.climate_vent_min_pct,
    nightMinOpenPercent: defaults.climate_vent_min_pct,
    nightMaxOpenPercent: 20,
    dayBaseOpenPercent: 10,
    dayMinOpenPercent: defaults.climate_vent_min_pct,
    dayMaxOpenPercent: defaults.climate_vent_max_pct,
    tempFullOpenDeltaC: 6,
    rhFullOpenDeltaPercent: 20,
    insideTempSpreadAlertC: 4,
    insideRhSpreadAlertPercent: 15,
    coldGuardMarginC: 1,
    coldGuardMaxOpenPercent: 10,
    outsideHotterGain: 1,
    outsideWetterGain: 1,
    ...
    windReduceThresholdMs: 8,
    windCloseThresholdMs: 12,
    windReduceWindwardMaxPercent: 25,
    windReduceLeewardMaxPercent: 50,
    windStormWindwardMaxPercent: 0,
    windStormLeewardMaxPercent: 10,
    rainWindwardPositionPercent: 0,
    rainLeewardPositionPercent: 10,
    rainUnknownDirectionMaxPercent: 5,
    overheatEmergencyTempC: 38,
    sensorFreshnessSeconds: 1200,
    greenhouseOrientationDeg: null,
    leftRoofNormalDeg: null,
...
export function createDefaultWaterForm(defaults: AutomationDefaultsSettings): WaterFormState {
  return {
    ...
    irrigationRecoveryEnabled: defaults.water_irrigation_recovery_enabled,
