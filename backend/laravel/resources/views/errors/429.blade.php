...
<head>
    ...
    <title>429 - {{ $brandName }}</title>
    <style>
        :root {
            --bg: #f5f2ea;
            --panel: rgba(255, 255, 255, 0.8);
            --panel-strong: rgba(255, 255, 255, 0.94);
            --border: rgba(209, 194, 168, 0.54);
            --text: #191c1e;
            --muted: #5d584f;
            --dim: #857c70;
            --accent: #9c6a12;
            --accent-2: #d29c2f;
            --shadow: 0 24px 70px rgba(41, 31, 10, 0.14);
        }
        * { box-sizing: border-box; }
        ...
        body {
            min-height: 100vh;
            background:
                radial-gradient(at 0% 0%, rgba(156, 106, 18, 0.06) 0px, transparent 50%),
        ...
        .orb {
            position: fixed; pointer-events: none; z-index: -1; border-radius: 9999px; filter: blur(90px);
        }
        .orb--one { top: -6rem; left: -6rem; width: 20rem; height: 20rem; background: rgba(156, 106, 18, 0.08); }
        .orb--two { right: -8rem; bottom: -8rem; width: 28rem; height: 28rem; background: rgba(210, 156, 47, 0.08); }
        .topbar {
            position: sticky; top: 0; z-index: 10;
            background: rgba(255, 255, 255, 0.72);
            backdrop-filter: blur(16px);
            border-bottom: 1px solid rgba(209, 194, 168, 0.36);
        }
        ...
        .brand__mark {
            ...
            box-shadow: 0 14px 28px rgba(156, 106, 18, 0.18); font-weight: 800; letter-spacing: 0.18em;
        }
        ...
        .pill {
            ...
            background: rgba(255, 255, 255, 0.72); border: 1px solid rgba(209, 194, 168, 0.45);
        ...
        .status { margin-top: 1.5rem; padding: 1rem 1.1rem; border-radius: 1rem; background: rgba(156, 106, 18, 0.08); border: 1px solid rgba(156, 106, 18, 0.18); color: #8d6518; font-size: 0.95rem; font-weight: 600; }
        ...
        .details { margin-top: 1rem; padding: 1rem 1.1rem; border-radius: 1rem; background: rgba(234, 224, 212, 0.56); border: 1px solid rgba(209, 194, 168, 0.52); color: var(--muted); }
        ...
        .btn--primary { background: linear-gradient(135deg, var(--accent) 0%, var(--accent-2) 100%); color: #fff; box-shadow: 0 18px 40px rgba(156, 106, 18, 0.22); }
        ...
        .footer { border-top: 1px solid rgba(209, 194, 168, 0.34); background: rgba(255, 255, 255, 0.5); }
        .footer__inner {
    ...
    <header class="topbar">
        <div class="topbar__inner">
            ...
            <div class="topbar__actions">
                <span class="pill">Статус: 429</span>
                ...
                <div class="visual__content">
                    <div class="visual__brand">
                        ...
                        <div>
                            ...
                            <div style="font-size: 0.72rem; text-transform: uppercase; letter-spacing: 0.26em; color: rgba(255,255,255,0.64);">Request throttle layer</div>
                        </div>
                    </div>

                    <h1 class="visual__title">429</h1>
                    <p class="visual__text">
                        Система временно ограничила частоту запросов. Это защита от перегрузки,
                        а не отказ сервиса. Подождите немного и повторите действие.
                    </p>
                </div>
            </aside>

            <div class="card__body">
                <p class="eyebrow">Ограничение частоты</p>
                <h2 class="body__title">Слишком много запросов</h2>
                <p class="body__subtitle">
                    Мы получили больше запросов, чем допускает текущий лимит. Подождите немного и повторите попытку.
                </p>
                ...
                @isset($retry_after)
                    <div class="status">Повторите через {{ (int) $retry_after }} сек.</div>
