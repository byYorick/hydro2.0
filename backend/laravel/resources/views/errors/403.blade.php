...
<head>
    ...
    <title>403 - {{ $brandName }}</title>
    <style>
        :root {
            --bg: #f7f4ef;
            --panel: rgba(255, 255, 255, 0.8);
            --panel-strong: rgba(255, 255, 255, 0.94);
            --border: rgba(214, 197, 177, 0.54);
            --text: #191c1e;
            --muted: #5d584f;
            --dim: #857c70;
            --accent: #a45b22;
            --accent-2: #d17a2a;
            --shadow: 0 24px 70px rgba(42, 29, 14, 0.14);
        }
        * { box-sizing: border-box; }
        ...
        body {
            min-height: 100vh;
            background:
                radial-gradient(at 0% 0%, rgba(164, 91, 34, 0.06) 0px, transparent 50%),
                radial-gradient(at 100% 100%, rgba(209, 122, 42, 0.05) 0px, transparent 50%),
                var(--bg);
            color: var(--text);
        ...
        .orb--one { top: -6rem; left: -6rem; width: 20rem; height: 20rem; background: rgba(164, 91, 34, 0.08); }
        .orb--two { right: -8rem; bottom: -8rem; width: 28rem; height: 28rem; background: rgba(209, 122, 42, 0.08); }
        .topbar {
            position: sticky; top: 0; z-index: 10;
            background: rgba(255, 255, 255, 0.72);
            backdrop-filter: blur(16px);
            border-bottom: 1px solid rgba(214, 197, 177, 0.36);
        }
        .topbar__inner, .footer__inner, .shell {
        ...
        .brand__mark {
            ...
            box-shadow: 0 14px 28px rgba(164, 91, 34, 0.18); font-weight: 800; letter-spacing: 0.18em;
        }
        ...
        .pill {
            display: inline-flex; align-items: center; gap: 0.45rem; padding: 0.55rem 0.85rem;
            border-radius: 9999px; background: rgba(255, 255, 255, 0.72);
            border: 1px solid rgba(214, 197, 177, 0.45);
        ...
        .card__body {
            padding: 3rem 3rem 2.5rem; display: flex; flex-direction: column; justify-content: center; background: var(--panel-strong);
        }
        ...
        .status { margin-top: 1.5rem; padding: 1rem 1.1rem; border-radius: 1rem; background: rgba(164, 91, 34, 0.08); border: 1px solid rgba(164, 91, 34, 0.18); color: #8d4a18; font-size: 0.95rem; font-weight: 600; }
        ...
        .details { margin-top: 1rem; padding: 1rem 1.1rem; border-radius: 1rem; background: rgba(234, 224, 212, 0.56); border: 1px solid rgba(214, 197, 177, 0.52); color: var(--muted); }
        ...
        .btn--primary { background: linear-gradient(135deg, var(--accent) 0%, var(--accent-2) 100%); color: #fff; box-shadow: 0 18px 40px rgba(164, 91, 34, 0.22); }
        .btn--secondary { background: rgba(255, 255, 255, 0.78); border-color: rgba(120, 110, 96, 0.65); color: var(--text); }
        .btn--ghost { background: transparent; border-color: rgba(120, 110, 96, 0.65); color: var(--accent); }
        .footer { border-top: 1px solid rgba(214, 197, 177, 0.34); background: rgba(255, 255, 255, 0.5); }
        .footer__inner {
    ...
    <header class="topbar">
        <div class="topbar__inner">
            ...
            <div class="topbar__actions">
                <span class="pill">Статус: 403</span>
                ...
                <div class="visual__content">
                    <div class="visual__brand">
                        ...
                        <div>
                            ...
                            <div style="font-size: 0.72rem; text-transform: uppercase; letter-spacing: 0.26em; color: rgba(255,255,255,0.64);">Access control layer</div>
                        </div>
                    </div>

                    <h1 class="visual__title">403</h1>
                    <p class="visual__text">
                        Этот маршрут существует, но у текущей сессии нет прав для доступа к нему.
                        Проверьте роль, авторизацию или откройте нужный раздел после входа.
                    </p>
                </div>
            </aside>

            <div class="card__body">
                <p class="eyebrow">Ошибка доступа</p>
                <h2 class="body__title">Доступ запрещен</h2>
                <p class="body__subtitle">
                    У текущего пользователя недостаточно прав для выполнения этого действия.
                    Если это ошибка, повторите вход или обратитесь к администратору.
                </p>
