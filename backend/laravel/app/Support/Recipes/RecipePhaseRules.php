...
class RecipePhaseRules
{
    ...
    private static function build(string $prefix, bool $partial): array
    {
        ...
        return [
            ...
            $prefix.'irrigation_system_type' => ['nullable', 'string', 'in:drip_tape,drip_emitter,ebb_flow,nft,dwc,aeroponics'],
            $prefix.'substrate_type' => ['nullable', 'string', 'max:64'],
            $prefix.'day_night_enabled' => ['nullable', 'boolean'],
