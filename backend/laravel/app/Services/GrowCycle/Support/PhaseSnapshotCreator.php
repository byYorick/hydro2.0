...
class PhaseSnapshotCreator
{
    public function create(
        ...
        return GrowCyclePhase::create([
            ...
            'solution_temp_target' => $templatePhase->solution_temp_target,
            'solution_temp_min' => $templatePhase->solution_temp_min,
            'solution_temp_max' => $templatePhase->solution_temp_max,
