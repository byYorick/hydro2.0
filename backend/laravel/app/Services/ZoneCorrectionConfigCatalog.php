    ...
    public static function fieldCatalog(): array
    {
        return [
            ...
            [
                'key' => 'timing',
                'label' => 'Timing',
                'description' => 'Тайминги стабилизации, ожидания перемешивания и freshness telemetry.',
                'advanced_only' => false,
                'fields' => [
                    ...
                    self::field('timing.ec_mix_wait_sec', 'EC mix wait', 'Пауза после EC-дозы перед новой оценкой эффекта.', 'integer', ['min' => 1, 'max' => 3600]),
                    self::field('timing.ph_mix_wait_sec', 'pH mix wait', 'Пауза после pH-дозы перед новой оценкой эффекта.', 'integer', ['min' => 1, 'max' => 3600]),
            ...
            [
                'key' => 'dosing',
                'label' => 'Dosing',
                'description' => 'Fallback-параметры дозирования и каналы актуаторов.',
                'advanced_only' => false,
                'fields' => [
                    self::field('dosing.solution_volume_l', 'Solution volume', 'Расчётный объём раствора для fallback-dose scaling.', 'number', ['min' => 1.0, 'max' => 10000.0, 'step' => 0.1]),
                    self::field('dosing.ec_dose_ml_per_mS_L', 'EC dose ml per mS/L', 'Fallback-чувствительность EC-дозы, если process calibration недоступна.', 'number', ['min' => 0.001, 'max' => 100.0, 'step' => 0.001, 'advanced_only' => true]),
                    self::field('dosing.ph_dose_ml_per_unit_L', 'pH dose ml per unit/L', 'Fallback-чувствительность pH-дозы, если process calibration недоступна.', 'number', ['min' => 0.001, 'max' => 50.0, 'step' => 0.001, 'advanced_only' => true]),
                    self::field('dosing.max_ec_dose_ml', 'Fallback max EC dose', 'Жёсткий верхний clamp EC-дозы до преобразования в pump pulse.', 'number', ['min' => 0.1, 'max' => 1000.0, 'step' => 0.1, 'advanced_only' => true]),
                    self::field('dosing.max_ph_dose_ml', 'Fallback max pH dose', 'Жёсткий верхний clamp pH-дозы до преобразования в pump pulse.', 'number', ['min' => 0.1, 'max' => 1000.0, 'step' => 0.1, 'advanced_only' => true]),
            ...
            [
                ...
                'description' => 'Масштабирование пауз смешивания по объёму раствора.',
                'advanced_only' => true,
                'fields' => [
