    ...
    public static function fieldCatalog(): array
    {
        return [
            [
                ...
                'advanced_only' => false,
                'fields' => [
                    self::field('controllers.ph.mode', 'Режим pH controller', 'DEPRECATED/ignored-by-runtime: декоративный label схемы.', 'enum', ['options' => ['cross_coupled_pi_d'], 'readonly' => true]),
                    self::field('controllers.ph.kp', 'Kp (fallback)', 'Fallback Kp если zone.pid.ph отсутствует. При наличии zone.pid тюнинг — только PidConfigForm (zone.pid.ph.zone_coeffs).', 'number', ['min' => 0.0, 'max' => 1000.0, 'step' => 0.1, 'advanced_only' => true]),
                    self::field('controllers.ph.ki', 'Ki (fallback)', 'Fallback Ki; при zone.pid — редактировать zone.pid.ph.', 'number', ['min' => 0.0, 'max' => 100.0, 'step' => 0.01, 'advanced_only' => true]),
                    self::field('controllers.ph.kd', 'Kd (fallback)', 'Fallback Kd; при zone.pid — редактировать zone.pid.ph.', 'number', ['min' => 0.0, 'max' => 100.0, 'step' => 0.01, 'advanced_only' => true]),
                    ...
                    self::field('controllers.ph.deadband', 'Deadband (fallback)', 'Fallback deadband; при zone.pid AE3 берёт dead_zone.', 'number', ['min' => 0.0, 'max' => 2.0, 'step' => 0.01, 'advanced_only' => true]),
                    ...
                    self::field('controllers.ph.max_integral', 'Max integral', 'Канонический anti-windup clamp (AE3). zone.pid.max_integral не читается runtime.', 'number', ['min' => 0.001, 'max' => 500.0, 'step' => 0.1]),
            ...
            [
                ...
                'advanced_only' => false,
                'fields' => [
                    self::field('controllers.ec.mode', 'Режим EC controller', 'DEPRECATED/ignored-by-runtime: декоративный label схемы.', 'enum', ['options' => ['supervisory_allocator'], 'readonly' => true]),
                    self::field('controllers.ec.kp', 'Kp (fallback)', 'Fallback Kp если zone.pid.ec отсутствует. При наличии zone.pid тюнинг — только PidConfigForm.', 'number', ['min' => 0.0, 'max' => 1000.0, 'step' => 0.1, 'advanced_only' => true]),
                    self::field('controllers.ec.ki', 'Ki (fallback)', 'Fallback Ki; при zone.pid — редактировать zone.pid.ec.', 'number', ['min' => 0.0, 'max' => 100.0, 'step' => 0.01, 'advanced_only' => true]),
                    self::field('controllers.ec.kd', 'Kd (fallback)', 'Fallback Kd; при zone.pid — редактировать zone.pid.ec.', 'number', ['min' => 0.0, 'max' => 100.0, 'step' => 0.01, 'advanced_only' => true]),
                    ...
                    self::field('controllers.ec.deadband', 'Deadband (fallback)', 'Fallback deadband; при zone.pid AE3 берёт dead_zone.', 'number', ['min' => 0.0, 'max' => 5.0, 'step' => 0.01, 'advanced_only' => true]),
                    ...
                    self::field('controllers.ec.max_integral', 'Max integral', 'Канонический anti-windup clamp (AE3). zone.pid.max_integral не читается runtime.', 'number', ['min' => 0.001, 'max' => 500.0, 'step' => 0.1]),
