...
class GrowCycleController extends Controller
{
    ...
    /**
     * Построить DTO для UI
     */
    private function buildCycleDto(GrowCycle $cycle): array
    {
        $recipe = $cycle->recipe;
        ...
        // Если текущей стадии нет, определяем её автоматически
