...
class SimulationController extends Controller
{
    ...
    ): ?array
    {
        ...
        $hasActionAnchor = is_string($lastActionAt) && $lastActionAt !== '';
        $anchorTime = $hasActionAnchor ? Carbon::parse($lastActionAt) : now();
        ...
        return [
            ...
            'sim_now' => $simNow,
            'progress_source' => $hasActionAnchor ? 'actions' : 'timer',
        ];
    }
