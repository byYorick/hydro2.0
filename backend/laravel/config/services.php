...
return [
    ...
    */
    ...
    'automation_engine' => [
        ...
        'scheduler_dispatch_parallelism' => env('AUTOMATION_LARAVEL_SCHEDULER_DISPATCH_PARALLELISM', 8),
        ...
        'scheduler_lock_ttl_margin_sec' => env('AUTOMATION_LARAVEL_SCHEDULER_LOCK_TTL_MARGIN_SEC', 10),
