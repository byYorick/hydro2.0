...
const config: PlaywrightTestConfig = {
  webServer: {
    command: 'rm -f public/hot && php artisan e2e:auth-bootstrap --email=agronomist@example.com --role=admin --with-zone >/dev/null 2>&1 || true && php artisan serve --host=127.0.0.1 --port=8010',
    port: 8010,
