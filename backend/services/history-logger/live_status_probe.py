...
Адаптировано из ``mqtt-bridge/status_probe.py``. Сервисы раздельные: не импортировать
probe из mqtt-bridge. Только подписка на retained/status/lwt/heartbeat/telemetry —
публикация команд запрещена.
"""
