...
**Важно:** Дублированные реализации удалены. Эта реализация — единственный источник истины для E2E-симуляции. `node-emulator` (`backend/services/node-emulator`) — load-test only, не канон E2E; не сливать с `tests/node_sim`.
