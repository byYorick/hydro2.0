    ...
    def _get_suite_scenarios(self, suite_name: str) -> List[str]:
        ...
        suites = {
            ...
            "commands": [
                ...
                str(base_path / "commands" / "E15_command_ack_flow.yaml"),
                str(base_path / "commands" / "E16_command_timeout_flow.yaml"),
                str(base_path / "commands" / "E17_command_failed_flow.yaml"),
                str(base_path / "commands" / "E18_command_duplicate_response.yaml"),
            ],
            "alerts": [
            ...
            "grow_cycle": [
                ...
                str(base_path / "grow_cycle" / "E55_cycle_abort.yaml"),
                str(base_path / "grow_cycle" / "E56_override_targets.yaml"),
                str(base_path / "grow_cycle" / "E57_batch_targets.yaml"),
