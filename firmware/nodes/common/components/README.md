...
- `i2c_bus/` — общий драйвер I²C с mutex ✅
- `sensors/` — драйверы сенсоров:
  - `trema_ph/`, `trema_ec/`, `trema_light/` ✅
  - `sht3x/`, `ccs811/`, `ina209/`, `ph_sensor/`, `ec_sensor/` ✅
- `oled_ui/` — OLED UI ✅
- `pump_driver/`, `relay_driver/` — драйверы актуаторов ✅
- `ws2811_driver/` — planned (только `WS2811_GUIDE.md`)
