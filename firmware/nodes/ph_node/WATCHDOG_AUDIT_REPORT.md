...
- `task_status` - ✓ регистрируется в watchdog, периодически сбрасывает (каждую секунду)
- `task_command_processor` - ✓ регистрируется в watchdog, периодически сбрасывает (каждые 3 сек)
- `heartbeat_task` - ✓ регистрируется в watchdog, периодически сбрасывает (каждую секунду)
...
| `task_status` | 60 сек | 1 сек | ✓ |
| `task_command_processor` | По команде | 3 сек | ✓ |
| `heartbeat_task` | 15 сек | 1 сек | ✓ |
