/**
 * @file pump_node_framework_integration.h
...
#ifndef PUMP_NODE_FRAMEWORK_INTEGRATION_H
#define PUMP_NODE_FRAMEWORK_INTEGRATION_H
 ...
 * 
 * Используется в pump_node_tasks.c для периодической публикации телеметрии
 * 
...
#endif // PUMP_NODE_FRAMEWORK_INTEGRATION_H
