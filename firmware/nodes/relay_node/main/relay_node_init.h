/**
 * @file relay_node_init.h
 * @brief Component initialization, setup mode and callbacks for relay_node
 */

#ifndef RELAY_NODE_INIT_H
#define RELAY_NODE_INIT_H
