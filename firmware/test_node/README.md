...
- Для контуров pH/EC добавлен управляемый тестовый профиль:
  ...
  - пассивный drift смещён так, чтобы отклонения возникали стабильно;
...
- Для совместимости e2e-сценариев добавлены alias-каналы:
  - на `nd-test-irrig-1`: `main_pump`, `drain_pump`, `air_temp_c`, `air_rh`, `ph_sensor`, `ec_sensor`, `fan`, `heater`;
